            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                        ...
                        <div class="w-full pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <ul>
                                ...
                                <li class="mb-4">
                                    <label for="{{ $brand->slug }}" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="selectedBrands"
                                            value="{{ $brand->id }}" id="{{ $brand->slug }}" class="w-4 h-4 mr-2">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                <select wire:model.live="sortBy"
                                    ...
                                    <option value="higherprice">Sort by High Price</option>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        <a wire:click.prevent='@if ($product->stock > 0) addToCart({{ $product->id }}) @endif'
                                            href="#"
                                            class="flex items-center space-x-2
                                                @if ($product->stock == 0) cursor-not-allowed text-gray-400 dark:text-gray-500
                                                @else
                                                    text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300 @endif
                                            "
